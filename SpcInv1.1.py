...
def gameFrame(): # MAKE YOUR GAME IN THIS FUNCTIONS (will be called every frame)
    ...
    if once:
        ...
        heart1  = object({  #heart
            "#f2022a": [[-1, -1], [-2, 0], [1, 0], [2, 0], [1, -1], [1, 1], [0, 2] ],#Bullet
            "#a32603": [[0, 0], [-1, 1]],
            "#f777aa": [[-1, 0]],
            "#bd044e": [[0,1]] #Bullet
            },
        ...
        back2 = rectangleObj([0,5], [20,13], "#6C22A6", 1, True)
        back3 = rectangleObj([0,14], [20,22], "#6962AD", 1, True)
        back4 = rectangleObj([0,23], [20,31], "#83C0C1", 1, True)
        back5 = rectangleObj([0,32], [20,40], "#96E9C6", 1, True)
